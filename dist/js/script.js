...
function initTheme() {
  ...
  const themeToggleButtonDarkIcon = document.getElementById(
    "theme-toggle-button-dark-icon",
  );
  const themeToggleButtonLightIcon = document.getElementById(
...
function sendEmail(event) {
  ...
  if (name && email && message) {
    ...
    emailjs.send("service_b903pvg", "template_1euz35e", emailParams).then(
      function (response) {
